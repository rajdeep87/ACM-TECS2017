...
in UART . The FW CFG is shown in the left and the 
...
in format that resembles SMT-LIB2
standards~\footnote{http://smtlib.cs.uiowa.edu/}.  The bottom flow illustrates the
...
that this producer-consumer interaction pattern is not specific to the UART
 or SoC designs used as exemplars in this paper.  Malik et
...
a UART  and a complex SoC design.  In the future, we plan to extend our 
