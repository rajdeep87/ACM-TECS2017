...
of the interface functions.  This leads to a single-threaded sequential
co-verification model in C.  
%
...
FW to communicate with $\mathcal{SN}$. \rmcmt{explain instrumentation with
diagram} \\ 
%
