...
co-design properties of the SoC.  Column~1 in
...
FW.  Column~3~and~4 present the co-verification times using \hwcbmcv
at the bit-level and word-level, respectively.  Columns~5 report the
verification time using \verifox.  
...
\textbf{\emph{Detecting SoC bugs:}} We found one critical \emph{control bug} 
...
accelerator.  It is important to note that forward symbolic execution without
...
generate a unified co-verification model.  To this end, we presented a
path-based symbolic execution technique to automatically infer
scenario/transaction pairs from a co-verification model.  Our general observation
