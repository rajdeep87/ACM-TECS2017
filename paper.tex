...
We check whether the acknowledgment for data transmission and data reception arrives
...
%To this end, we classify co-design properties into two types --  \emph{transaction level} and \emph{component level} property.  
We proved several transaction and component level properties of UART and SoC
design using \hwcbmcv and \verifox.  
%We for proving safety as well as finding critical co-design bugs for a UART IP and a complex SoC design.  
